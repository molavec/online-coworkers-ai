...
<template>
  ...
  <label v-if="!prefersDark" class="toggle text-base-content">
    <input v-model="isDarkMode" type="checkbox" value="dark" class="theme-controller" @click="setPrefersColorScheme">
  ...
  <label v-if="prefersDark" class="toggle text-base-content">
    <input v-model="isDarkMode" type="checkbox" value="light" class="theme-controller" @click="setPrefersColorScheme">
  ...
  <!-- <label class="swap swap-rotate">
    ...
    <input v-model="isDarkMode" type="checkbox" class="theme-controller" value="dark" @click="setPrefersColorScheme">
